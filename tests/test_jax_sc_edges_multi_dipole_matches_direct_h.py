...
def test_edges_multi_dipole_matches_direct_h() -> None:
    jnp = _jnp()
    ...
    offsets = make_subdip_offsets_grid(2, cube_edge)

    h_ref = _compute_h_ext_u_near_multi_dipole(phi, r0, p, nbr_idx, nbr_mask, offsets)
    k_edge = _build_k_edge_multi_dipole(phi, r0, i_edge, j_edge, offsets)
